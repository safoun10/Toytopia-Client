			...
			<div className="row">
				<div className="col-11 col-md-6 mx-auto p-3">
					<img
						...
						alt="kid with lego"
					/>
					<div className="text-white">They love small cars 🙂</div>
				</div>
				<div className="col-11 col-md-6 mx-auto p-3">
					<img
						className="img-fluid rounded-3 img-border-custom"
						...
						alt="kid with lego"
					/>
					<div className="text-white">They love excitement !! 🙃</div>
				</div>
				<div className="col-11 col-md-6 mx-auto p-3">
					<img
						className="img-fluid rounded-3 img-border-custom"
				...
				<div className="col-11 col-md-6 mx-auto p-3">
					...
					/>
					<div className="text-white">
						Playing with children creates bonding between child and
						parent 🥰
					</div>
				</div>
				<div className="col-11 col-md-6 mx-auto p-3">
